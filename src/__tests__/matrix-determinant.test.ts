...
test("determinant value", () =>{
  ...
  const m3 = [[1, 2, 3, 4], [5, 0, 2, 8], [3,5,6,7],[2,5,3,1]];
  const m4 = [[2,5,3,6,3], [17,5,7,4,2], [7,8,5,3,2], [9,4,-6,8,3], [2,-5,7,4,2]];
  const m6 = [[1, 2, 4, 0, 9],[2, 3, 4, 1, 1],[6, 7, 3, 9, 3],[2, 0, 3, 0, 2],[4, 5, 2, 3, 1]];
  const m7 = [[2, 4, 5, 3, 1, 2],[2, 4, 7, 5, 3, 2],[1, 1, 0, 2, 3, 1],[1, 3, 9, 0, 3, 2],[1, 1, 2, 2, 4, 1],[0, 0, 4, 1, 2, 3]];
  const m8 = [[3, 2, 1, 4, 0, 1],[1, 2, 3, 1, 9, 1],[0, 2, 1, 1, 9, 0],[8, 2, 1, 0, 2, 3],[2, 3, 4, 0, 1, 2],[2, 1, 0, 0, 1, 1]];
...
test("determinant error", () =>{
  const m =  [[1,2]];
  const m2 =  [[1,2,3],[1,2]];
  const m3 =  [[1,2,3],[1,2,3],[1,2,3], [1,2]];
